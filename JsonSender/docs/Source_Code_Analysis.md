...
This document explains **every important line of code** in the JsonSender project. Think of it as a **guided tour** through the code, where we'll stop at each interesting part and explain what it does and why it matters.
...
```cpp
JsonSenderGUI window;  // Create our main window
...
- **&JsonSenderGUI::onConnect**: Method to call when event happens
...
The code demonstrates professional software development practices: clear separation of concerns, comprehensive error handling, proper resource management, and user-friendly interface design.